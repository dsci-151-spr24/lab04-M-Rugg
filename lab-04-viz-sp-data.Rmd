...
***There are `r nrow(laquinta)` rows and `r ncol(laquinta)` and columns in the dataset. Each row represents the data for one La Quintas Inn. The variables are `r names(laquinta)`.***
